...
export default function Home() {
  return (
      <main className="min-h-screen bg-white text-gray-900 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="bg-white border-gray-100 shadow-sm">
              <CardContent className="p-6 flex flex-col items-center text-center">
                ...
                />
                <p className="text-lg font-medium text-gray-800">
                  {"Nuestras bromas internas siempre me alegran el día."}
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white border-gray-100 shadow-sm">
        ...
        {/* Sección de Cierre / Footer */}
        <section className="py-16 px-4 md:px-8 bg-custom-pink text-white text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">{"¡Siempre Juntos!"}</h2>
          <p className="text-lg md:text-xl mb-8">{"Este es solo el comienzo de nuestra hermosa historia."}</p>
        </section>
